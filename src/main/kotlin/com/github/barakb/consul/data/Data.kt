...
data class ServiceCheck(
        @SerializedName("Service") val service: Service? = null, @SerializedName("Checks") val checks: List<HealthCheck> = listOf(), @SerializedName("Node") val node: Node? = null
)
...
data class Node(
        @SerializedName("Datacenter") val datacenter: String? = null, @SerializedName("TaggedAddresses") val taggedAddresses: TaggedAddresses? = null,
...
data class CatalogService(
        @SerializedName("Datacenter") val datacenter: String? = null, @SerializedName("ServiceName") val serviceName: String? = null, @SerializedName("ServiceID") val serviceId: String? = null, @SerializedName("ServiceAddress") val serviceAddress: String? = null, @SerializedName("ServiceEnableTagOverride") val serviceEnableTagOverride: Boolean = false, @SerializedName("ServicePort") val servicePort: Int? = null, @SerializedName("ServiceTags") val serviceTags: List<String> = listOf(), @SerializedName("ServiceMeta") val serviceMeta: List<String> = listOf(), @SerializedName("ServiceWeights") val serviceWeights: ServiceWeights? = null, @SerializedName("NodeMeta") val nodeMeta: List<String> = listOf(), @SerializedName("Address") val address: String? = null, @SerializedName("Node") val node: String? = null
)
